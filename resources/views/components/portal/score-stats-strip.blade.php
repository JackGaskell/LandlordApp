...
<div class="rounded-2xl bg-white/[0.03] p-4 ring-1 ring-white/[0.06] sm:p-5">
    ...
    @if ($recentTimeline->isNotEmpty())
        <div class="mt-4 flex items-center gap-3 border-t border-white/[0.06] pt-4">
            <span class="shrink-0 text-[10px] font-medium uppercase tracking-wider text-slate-600">Recent</span>
            <div class="flex flex-1 items-center justify-end gap-1.5 sm:justify-start">
